            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2 p-6">
                        <span class="flex text-md items-center mb-[10px] text-gray-500 capitalize">{{$book->kategori}}</span>
                        <h2 class="text-2xl font-bold text-gray-800 mb-2 uppercase">{{$book->judulbuku}}</h2>
                        <div class="flex items-center text-sm text-gray-500 mb-4 capitalize">
                        ...
                        <div class="border-t border-gray-200 pt-6 capitalize">
